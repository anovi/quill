...
PasteManager = (function() {
  ...
  PasteManager.prototype._paste = function() {
    var containerClientRect, oldDocLength, range, scrollTopBefore;
    oldDocLength = this.quill.getLength();
    range = this.quill.getSelection();
    scrollTopBefore = this.quill.container.scrollTop;
    containerClientRect = this.quill.container.getBoundingClientRect();
    if (range == null) {
      return;
    }
    ...
    return window.requestAnimationFrame((function(_this) {
      return function() {
        var delta, lengthAdded, line, lineBottom, lineClientRect, offset, ref;
        ...
        if ((scrollTopBefore + containerClientRect.top < lineBottom && lineBottom < scrollTopBefore + containerClientRect.top + containerClientRect.height)) {
          _this.quill.container.scrollTop = scrollTopBefore;
        } else {
          _this.quill.container.scrollTop = line.node.offsetTop + lineClientRect.height - containerClientRect.height / 2;
        }
...
UndoManager = (function() {
  ...
  UndoManager.prototype.redo = function() {
    this.quill.emit('redo');
    return this._change('redo', 'undo');
  };

  UndoManager.prototype.undo = function() {
    this.quill.emit('undo');
